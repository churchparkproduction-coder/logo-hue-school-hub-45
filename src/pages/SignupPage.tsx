        ...
        <div className="container-max py-16">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gradient mb-4">Join Our Community</h1>
              <p className="text-muted-foreground">
                Create your {SCHOOL_CONFIG.name} account
              </p>
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => setFormData({...formData, userType: value})}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="student">Prospective Student</SelectItem>
                        <SelectItem value="teacher">Educator/Staff</SelectItem>
